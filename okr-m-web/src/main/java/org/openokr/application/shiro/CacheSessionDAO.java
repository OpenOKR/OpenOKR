...
import org.openokr.utils.Servlets;
...
public class CacheSessionDAO extends EnterpriseCacheSessionDAO implements SessionDAO {
    ...
    protected void doUpdate(Session session) {
        ...
        if (request != null) {
            ...
            // 如果是视图文件，则不更新SESSION
            if (StringUtils.startsWith(uri, "/templates/")
                    && StringUtils.endsWith(uri, ".ftl")) {
                return;
            }
            // 手动控制不更新SESSION
            String updateSession = request.getParameter("updateSession");
            if ("true".equals(updateSession) || "false".equals(updateSession)) {
                return;
            }
        }
